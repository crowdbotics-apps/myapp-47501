"""
Django settings for myapp_47501 project.
...
WSGI_APPLICATION = 'myapp_47501.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "myapp_47501 API",
    "DESCRIPTION": "API documentation for myapp_47501 App",
    "VERSION": "v1",
}
